...
Greedy Method 1 (Sort by Profit)
Aim:
To maximize profit by selecting items with highest value first.
...
Applications:
Knapsack (approximation), resource allocation

Greedy Method 2 (Sort by Weight)

Aim:
To minimize weight by selecting items with smallest weight first.
...
Greedy Method 3 (Ratio Method - Value/Weight)

Aim:
To maximize profit using value/weight ratio.

Pseudo code:
Compute value/weight ratio
Sort items in descending order of ratio
Select items (fraction allowed)
